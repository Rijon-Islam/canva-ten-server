        ...
        app.put("/update-banner/:id", async (req, res) => {
            ...
            const updatedDoc = {
                $set: {
                    ...
                    sliderTextOne: bannerSection.sliderTextOne,
                    sliderTextTwo: bannerSection.sliderTextTwo,
        ...
        app.put("/update-about/:id", async (req, res) => {
            ...
            const updatedDoc = {
                $set: {
                    ...
                    completeProject: aboutSection.completeProject,
                    completeProjectdetails: aboutSection.completeProjectdetails,
...
app.listen(port, () => {
    console.log('Good Job, SEO 10 Server is Live Now', port);
});